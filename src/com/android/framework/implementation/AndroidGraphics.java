...
public class AndroidGraphics implements Graphics {
    ...
    public void drawRotatedImage(Image Image, int x, int y, int angle) {
    	Bitmap bMap = ((AndroidImage)Image).bitmap;
    	Matrix mtx = new Matrix();
    	
    	mtx.setRotate((float)angle,bMap.getWidth()/2,bMap.getHeight()/2);
    	mtx.postTranslate(x - bMap.getWidth()/2, y - bMap.getHeight()/2);
    	
    	canvas.drawBitmap(bMap, mtx, new Paint());
    }
